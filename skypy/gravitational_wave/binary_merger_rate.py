...
def abadie_tableIII_merger_rates(luminosity, population='NS-NS', optimism='low'):
  r"""Model of Abadie et al (2010), Table III

    Compact binary merger rates as a linear function of L_10 blue light luminosity.

    Parameters
    ----------
    luminosity : (ngal,) array-like
        The blue light luminosity L_10 of the galaxies to generate merger rates for,
        where L_10 = 10^10 * 2.16e33 erg/s.
  ...
  merger_rate = abadie_tableIII_dict[population, optimism] * luminosity / units.year
