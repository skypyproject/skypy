...
def check_internals(rv, args):
    ...
    common_tests.check_edge_support(rv, args)
    common_tests.check_random_state_property(rv, args)
    common_tests.check_pickling(rv, args)
...
def check_normalisation(rv, args):
    ...
    common_tests.check_normalization(rv, args, rv.name)
...
def check_moments(rv, args):
    ...
    # check moments
    common_tests.check_mean_expect(rv, args, m, rv.name)
    common_tests.check_var_expect(rv, args, m, v, rv.name)
    common_tests.check_skew_expect(rv, args, m, v, s, rv.name)
    common_tests.check_kurt_expect(rv, args, m, v, k, rv.name)
    common_tests.check_moment(rv, args, m, v, rv.name)
